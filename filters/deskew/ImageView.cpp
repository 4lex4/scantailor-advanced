...
const double ImageView::m_maxRotationSin = sin(m_maxRotationDeg * imageproc::constants::DEG2RAD);
...
QPointF ImageView::getImageRotationOrigin() const {
    ...
    return QPointF(floor(0.5 * viewport_rect.width()) + 0.5, floor(0.5 * viewport_rect.height()) + 0.5);
}
