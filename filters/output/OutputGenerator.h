...
private:
    ...
    static imageproc::GrayImage normalizeIlluminationGray(TaskStatus const& status,
                                                          ...
                                                          imageproc::GrayImage* background = 0,
                                                          DebugImages* dbg = 0);
    ...
    void modifyBinarizationMask(imageproc::BinaryImage& bw_mask, QRect const& mask_rect, ZoneSet const& zones) const;

    imageproc::BinaryThreshold adjustThreshold(imageproc::BinaryThreshold threshold) const;

    imageproc::BinaryThreshold calcBinarizationThreshold(QImage const& image, imageproc::BinaryImage const& mask) const;
