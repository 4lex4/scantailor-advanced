...
namespace imageproc
{
    namespace detail
    {
        namespace find_peaks
        {
            ...
            void
            raiseAllButPeaks(MostSignificantSelector most_significant,
    ...
    void
    findPeaksInPlaceGeneric(MostSignificantSelector most_significant,
                            LeastSignificantSelector least_significant,
                            IncreaseSignificance increase_significance,
    ...
    template <typename T, typename MostSignificantSelector,
              typename LeastSignificantSelector, typename IncreaseSignificance>
    BinaryImage
    findPeaksGeneric(MostSignificantSelector most_significant,
                     LeastSignificantSelector least_significant,
                     IncreaseSignificance increase_significance,
                     QSize peak_neighborhood,
                     T outside_values,
