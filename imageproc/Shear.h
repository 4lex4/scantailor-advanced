...
namespace imageproc
{
     ...
     */
    void hShearFromTo(BinaryImage const& src, BinaryImage& dst, double shear, double y_origin,
     ...
     * \note The source and destination images must have the same size.
     */
    void vShearFromTo(BinaryImage const& src, BinaryImage& dst, double shear, double x_origin,
                      BWColor background_color);
