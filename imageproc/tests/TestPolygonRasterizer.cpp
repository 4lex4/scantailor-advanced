...
namespace imageproc
{
    namespace tests
    {
        ...
        static QPolygonF
        createShape(QSize const& image_size, double radius)
        {
        ...
        static bool
        fuzzyCompare(BinaryImage const& img, QImage const& control)
        {
        ...
        static bool
        testFillShape(QSize const& image_size, QPolygonF const& shape, Qt::FillRule fill_rule)
        {
        ...
        static bool
        testFillExceptShape(QSize const& image_size, QPolygonF const& shape, Qt::FillRule fill_rule)
        {
            BinaryImage b_image(image_size, WHITE);
