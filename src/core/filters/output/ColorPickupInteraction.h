...
#ifndef SCANTAILOR_OUTPUT_COLORPICKUPINTERACTION_H_
#define SCANTAILOR_OUTPUT_COLORPICKUPINTERACTION_H_
...
#endif  // ifndef SCANTAILOR_OUTPUT_COLORPICKUPINTERACTION_H_
